"""
Django settings for hulchull_event_backend project.
...
SECRET_KEY = 'django-insecure-m2m2(fiwqs+4@+==(78y()5bp)*m_v4%l(3!-)_y1ry8$^*i69'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["*","karthik567.pythonanywhere.com"]
...
ROOT_URLCONF = 'hulchull_event_backend.urls'
...
WSGI_APPLICATION = 'hulchull_event_backend.wsgi.application'
